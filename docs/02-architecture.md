...
| Поле | Значення |
|---|---|
| Версія | 0.2 (на затвердження, Фаза 1; оновлено 2026-09-25 за стратегічними рішеннями Алекса: старт «Економ», модульність — ADR-017, готовність до комерціалізації — ADR-018) |
| Дата | 2026-09-25 |
| Автор | `architect` |
| Вхідні | `docs/00-product-brief.md`, `docs/01-requirements.md` v0.3 (затв. 2026-09-25), `docs/05-backlog.md` v0.3 |
| Пов'язані | `docs/03-resources-and-costs.md` (акаунти, ключі, кошторис), `docs/adr/001…018` |
...
| `child_profile` | `nickname`, `tutor_name`, `lesson_minutes` (30/45), `break_after_min` (20), `idle_hint_s` (60), `idle_pause_s` (180), `friend_voice_daily_min` (10 — рішення Алекса 2026-09-25), `voice_silence_close_s` (60), `target_lang_share` | Нікнейм — єдине «ім'я», що йде в моделі (D-30). |
